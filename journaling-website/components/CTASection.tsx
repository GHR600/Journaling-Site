    ...
    <section className="py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-text-secondary text-lg mb-12 max-w-2xl mx-auto">
          Join the waitlist to get early access and be notified when Journaling launches on Google Play and Apple App Store.
        </p>
        ...
        <div className="mt-16 p-8 bg-card/50 rounded-xl border border-primary/20">
          ...
          <p className="text-text-secondary leading-relaxed max-w-2xl mx-auto">
            I built Journaling because I believe everyone deserves to understand themselves better.
